...
go build -ldflags "-X github.com/lasthyphen/duluth/plugin/evm.GitCommit=$coreth_commit -X github.com/lasthyphen/duluth/plugin/evm.Version=$coreth_version" -o "$binary_path" "plugin/"*.go
